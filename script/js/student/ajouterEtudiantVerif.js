...
redirection.addEventListener("click", function(e){
    ...
    // requete de verification de l'exitance de classe
    ...
    xhr.onreadystatechange = function(){
        ...
        if(this.readyState == 4 && this.status == 200){
            ...
            // reception de la reponce et formatage
                ...
                window.location.href = "../formulaire/formulaireEtudiant.php";
            }
    ...
    xhr.open("POST", "../../script/php/student/verificationExistance.php", true);
