...
redirection.addEventListener("click", function(e){
    ...
    // requete de verification de l'exitance de auteur et de genre
    ...
    xhr.onreadystatechange = function(){
        ...
        if(this.readyState == 4 && this.status == 200){
            ...
            // reception de la reponce et formatage
                ...
                window.location.href = "../formulaire/formulaireEmprunt.php";
            }
    ...
    xhr.open("POST", "../../script/php/loan/verificationExistance.php", true);
