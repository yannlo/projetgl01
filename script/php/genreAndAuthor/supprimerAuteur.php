 ...
 */
   ...
   $_SESSION['codeErreur']["message"] ="Suppression des auteurs suivante: <br/>";
  ...
  if(isset($_POST['selector'])){
    ...
    // creation de la requete de supression de auteur
    $request = $bdd -> prepare("UPDATE auteur SET DELETEAUTEUR = :deleteA WHERE IDAUTEUR = :idA");
