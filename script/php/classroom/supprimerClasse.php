 ...
 */
   ...
   $_SESSION['codeErreur']["message"] ="Suppression des classes suivante: <br/>";
  ...
  if(isset($_POST['selector'])){
    ...
    // creation de la requete de supression de classe
    $request = $bdd -> prepare("UPDATE classe SET DELETECL = :deletecl WHERE CODECL = :code");
